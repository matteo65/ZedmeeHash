...
abstract class ZedmeeHash {
	...
	public ZedmeeHash(int seed1, int seed2, int seed3, int seed4) {
		genByteTable(seed1, seed2, seed3, seed4);
		byteTable0 = byteTable[0];
	}
	
	public ZedmeeHash(int seed) {
